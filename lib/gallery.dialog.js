         ...
         success: function(responseText, status, xhr, form) {
           ...
           if (xhr) {
             ...
             if (mimeType[1] == "application/json") {
               ...
               data = {"html": escape(xhr.responseText)};
             }
           } else {
             ...
             //   "location":"\/gallery3\/index.php\/admin\/watermarks"}</pre>
             // bizarre.  Strip that off before parsing.
	     //
	     // Note: commented out as part of the great jQuery 1.7.2 upgrade so that we can
	     // see whether or not this is still necessary.
             // data = JSON.parse(xhr.responseText.match("({.*})")[0]);
           }
